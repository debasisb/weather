...
app.post("/", function(req, res) {
    ...
    // takes in the zip from the html form, display in // console. Takes in as string, ex. for zip 02139
        var cityID = String(req.body.idInput);
    ...
    https.get(url, function(response){
        ...
        response.on("data", function(data){
            ...
            res.write("<h2>The windspeed is " + speed + "mph, " + " and the wind direction is " + direction + " degrees" + ", and the cloudiness is " + cloudiness + "%" + " and the humidity is " + humidity + " %<h2>");
